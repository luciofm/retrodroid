...
package com.luciofm.retrodroid.location;
...
import com.luciofm.retrodroid.R;
...
public class LegacyLocationUpdateRequester extends LocationUpdateRequester{
  ...
  public LegacyLocationUpdateRequester(LocationManager locationManager, Context context) {
		...
		alarmManager.setInexactRepeating(
				...
				System.currentTimeMillis()
						+ context.getResources().getInteger(
								R.integer.location_request_time),
				context.getResources().getInteger(
						R.integer.location_request_time), pendingIntent);
	}
}
